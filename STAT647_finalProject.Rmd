...
- QR does not make any assumptions about a parametric likelihood which is problematic for the Bayesian framework for the posterior estimatio. 
...
To assess the performance of the model and make sure that it works properly, we conducted a simulation study

...
we provide an alternative to methods outlined in Reich et al. (2011) and Smith et al. (2015), circumventing the bias in the posterior variance induced by ALD based likelihoods.
...
We have encountered several issues throughout this process, most notably involving the values within the weight matrix $W$. The values within the weight matrix $W$ tend to be quite large (of the order $10^4$). Because the weight matrix appears in the quadratic exponent of the likelihood function,  
